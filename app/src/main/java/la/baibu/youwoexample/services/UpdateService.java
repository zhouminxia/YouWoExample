...
import la.baibu.youwoexample.bean.Version;

/**
 * Created by minna_Zhou on 2017/3/15 0015.
 */
public class UpdateService extends IntentService {
     ...
     *一定要无参构造函数，因为系统初始化是无参的super("name").
     */
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String download = mVersion.getDownload();
        InputStream in = null;
        ...
        try {
            ...
            File apkFile = new File(dir, "mytestapk");
